...
export const STELLAR: StellarConfig = {
  ...
  TOKEN_CONTRACT: {
    // TODO: get these values from backoffice
    NATIVE:
      getValueFromEnv('STELLAR_TOKEN_CONTRACT_NATIVE') || 'CDLZFC3SYJYDZT7K67VZ75HPJVIEUVNIXF47ZG2FB2RMQQVU2HHGCYSC',
  },
  AIRDROP_CONTRACT_ADDRESS:
    getValueFromEnv('STELLAR_AIRDROP_CONTRACT_ADDRESS') || 'CAI2ZXTG5DJ5LLIJG25OJG3K5JLTQZKXGZVI4X556GIBSJNVFKE6445I',
  GIFT_AIRDROP_CONTRACT_ADDRESS: getValueFromEnv(
    'STELLAR_GIFT_AIRDROP_CONTRACT_ADDRESS',
    'CAI2ZXTG5DJ5LLIJG25OJG3K5JLTQZKXGZVI4X556GIBSJNVFKE6445I'
  ),
  STELLAR_RPC_AUTH_HEADER_NAME: getValueFromEnv('STELLAR_RPC_AUTH_HEADER_NAME', '') || undefined,
  STELLAR_RPC_AUTH_HEADER_VALUE: getValueFromEnv('STELLAR_RPC_AUTH_HEADER_VALUE', '') || undefined,
}
