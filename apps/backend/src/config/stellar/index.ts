...
export const STELLAR: StellarConfig = {
  ...
  SOROBAN_RPC_AUTH_HEADER_NAME: getValueFromEnv('STELLAR_SOROBAN_RPC_AUTH_HEADER_NAME'),
  SOROBAN_RPC_AUTH_HEADER_VALUE: getValueFromEnv('STELLAR_SOROBAN_RPC_AUTH_HEADER_VALUE'),
}
